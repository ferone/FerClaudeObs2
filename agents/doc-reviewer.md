...
You work as part of a coordinated agent team. When reviewing docs:
- Cross-reference with `@code-reviewer` findings — if they found API changes, check docs match
