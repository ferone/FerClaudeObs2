...
- If performance fixes introduce security risks (e.g., caching sensitive data), flag for `@security-reviewer` via SendMessage
- Share findings with `@code-reviewer` so they can reference performance issues in the overall assessment
